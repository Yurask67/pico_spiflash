...
void loop()
{
  ...
  // или еще можно отловить момент записи
  ...
  if (Serial.available())
  {
    // Serial.setTimeout(5000); // 5 сек таймаут ожидания между символами
    // при вводе с клавиатуры данных в ммилисек
